...
case 1: { // KKKKKKKKKKK NÃO SEI FAZER =>> Eu fiz assim o que acha?
system("cls || clear");	
...
case 5: { // Esse aqui andei dando umas pesquisadas, mas está meio nebuloso ainda 
system("cls || clear");	
...
printf("\n========================================\n=================  05  =================\n========================================\n");
		...
		/*
		Quando começa o outono: 20 ou 21 de março.
		Quando acaba o outono: 20 ou 21 de junho.
		
		Quando começa o inverno: 20 ou 21 de junho.
		Quando acaba o inverno: 22 ou 23 de setembro.
		
		Quando começa a primavera: 22 ou 23 de setembro.
		Quando acaba a primavera: 21 ou 22 de dezembro.
		
		Quando começa o verão: 21 ou 22 de dezembro.
		Quando acaba o verão: 20 ou 21 de março.
		*/
...
case 8: { // Naquele que vc fez da consoante eu digitei minusculo e ele identificou normal acho que se vc fizer o msm aqui não precisaria de dois cases, aparentemente eu estava cero rsrs.
system("cls || clear");	
...
case 12: {
system("cls || clear");	//Preciso voltar nessa questão o primeiro for dá bixado não repete o quanto deveria.
...
printf("\n========================================\n=================  14  =================\n========================================\n");
	...
	//Bobinho estava no caminho certo kkkk. Quando visualizar fica a vontade para apagar os comentárioos daqui k
	
	
	/* SOMENTE UM TESTE!!! (Sei fazer assim... Usando Switch-case ?? Não consigo relacionar as coisas. 
