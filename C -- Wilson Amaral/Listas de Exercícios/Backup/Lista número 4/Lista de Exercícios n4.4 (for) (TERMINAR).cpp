...
printf("\n========================================\n=================  05  =================\n========================================\n");
	...
	unsigned int N,A; //Aqui deveria ser número, mas vou usar as variáveis do problema, essa aqui vou ter que queimar mais neuronio ou pesquisar pq não veio nada
